...
The WindBlade Projectile Attack, in which the enemy shoots a projectile towards the player, is only executed if the opponent is not too close to the player. The player can then dodge or block this attack.   
